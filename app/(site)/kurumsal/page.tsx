...
export default function DocsPage() {
  return (
    ...
    <div className="flex justify-center custom-swiper deactive-mobile relative w-full page-md-h">
        <Image src="/images/pages/kurumsal_page.webp" className="brightness-75" fill alt="ekdag-gozde-logo.jpg" />
      </div>

      <div className="flex justify-center active-mobile custom-swiper relative w-full page-sm-h">
        <Image src="/images/pages/kurumsal_mob_page.webp" className="brightness-75" fill alt="ekdag-gozde-logo.jpg" />
      </div>
